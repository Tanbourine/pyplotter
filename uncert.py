...
def add_uncertainty(propogated_value):
    ''' add two values together and find uncertainty'''
    print("Adding two values with uncertainties")
    input_value = get_input()
    output = propogated_value + input_value
    format_output(output)
    return output


def subtract_uncertainty(propogated_value):
...
def multiply_uncertainty(propogated_value):
...
def divide_uncertainty(propogated_value):
...
def main():
    ''' main function '''
    add_uncertainty(multiply_uncertainty(get_input()))
